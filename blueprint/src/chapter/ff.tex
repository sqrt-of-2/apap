...
\begin{lemma}
\label{ast_le_circ}
\lean{cLpNorm_conv_le_cLpNorm_dconv}
\leanok
...
\begin{proof}
\uses{global_dichotomy, unbalancing, ap_in_ff, circ_expand, sift_cor}
\leanok
...
\begin{lemma}
  ...
  \lean{ThreeAPFree.wInner_one_mu_ddconv_mu_mu_two_smul_mu}
  \leanok
